...
public:
	...
	virtual int getExpectedTypeID(TypeInterface* type) const=0; ///< Tworzy niebezpieczne wiązania
	virtual TypeInterface* getTypeByID(int ID) const=0; ///< Wykorzystuje niebezpieczne wiązania
};
